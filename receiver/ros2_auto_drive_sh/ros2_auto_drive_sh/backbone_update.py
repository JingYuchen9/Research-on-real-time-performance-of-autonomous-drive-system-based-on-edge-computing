...
from hybridnets.modelv1 import BiFPN, Regressor, Classifier, BiFPNDecoder
from utils.utils import Anchors
from hybridnets.modelv1 import SegmentationHead
...
class HybridNetsBackbone(nn.Module):
    def __init__(self, num_classes=80, compound_coef=0, seg_classes=1, backbone_name=None, seg_mode=MULTICLASS_MODE,
        ...
        self.attp2 = AttentionModule(24)
        self.attp3 = AttentionModule(160)
        self.attp4 = AttentionModule(160)
        self.attp5 = AttentionModule(160)
        self.attp6 = AttentionModule(160)
        self.attp7 = AttentionModule(160)
