...
def get_args():
    ...
    parser.add_argument('-b', '--batch_size', type=int, default=8, help='Number of images per batch among all devices')
    ...
    parser.add_argument('--save_interval', type=int, default=20000, help='Number of steps between saving')
...
def train(opt):
    ...
    file_Cls_loss = 'Cls_loss.txt'
    file_Reg_loss = 'Reg_loss.txt'
    file_Seg_loss = 'Seg_loss.txt'
    file_Total_loss = 'Total_loss.txt'
    f_cls = open(file_Cls_loss, 'w')
    f_reg = open(file_Reg_loss, 'w')
    f_seg = open(file_Seg_loss, 'w')
    f_total = open(file_Total_loss, 'w')
    try:
        for epoch in range(opt.num_epochs):
            ...
            for iter, data in enumerate(progress_bar):
                ...
                try:
                    ...
                    f_cls.write(f'{cls_loss:.5f}\n')
                    f_reg.write(f'{reg_loss:.5f}\n')
                    f_seg.write(f'{seg_loss:.5f}\n')
                    f_total.write(f'{loss:.5f}\n')
