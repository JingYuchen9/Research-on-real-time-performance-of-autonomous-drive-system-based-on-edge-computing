...
# # from MSCA import AttentionModule # 有效果 但不多
...
#             DepthWiseConv2d(3, 64, kernel_size=(3, 3), padding=(1, 1)),
#             nn.GroupNorm(4, 64),
...
#             DepthWiseConv2d(64, 64, kernel_size=(3, 3), padding=(1, 1)),
#             # nn.GroupNorm(4, 64),
#             GRN(64),
#             nn.LeakyReLU(inplace=False),
#             # nn.Conv2d(64, 64, kernel_size=(3, 3), padding=(1, 1)),
...
#         #     # DepthWiseConv2d(64, 128, kernel_size=1),
#         #     nn.GroupNorm(4, 128),
#         #     nn.LeakyReLU(inplace=False),
#         #     nn.MaxPool2d((2, 2)),
#         #     # AttentionModule(dim=128)
#         # )
...
#             DepthWiseConv2d(128, 128, kernel_size=3, padding=1),
#             # nn.GroupNorm(4, 128),
#             GRN(128),
#             nn.LeakyReLU(inplace=False),
#             # nn.Conv2d(128, 128, kernel_size=(3, 3), padding=(1, 1)),
...
#         #     # DepthWiseConv2d(128, 256, kernel_size=1),
#         #     nn.GroupNorm(4, 256),
#         #     nn.LeakyReLU(inplace=False),
#         #     nn.MaxPool2d((2, 2)),
#         #     # AttentionModule(dim=256)
#         # )
...
#             DepthWiseConv2d(256, 256, kernel_size=(3, 3), padding=(1, 1)),
#             # nn.GroupNorm(4, 256),
#             GRN(256),
#             nn.LeakyReLU(inplace=False),
#             # nn.Conv2d(256, 256, kernel_size=(3, 3), padding=(1, 1)),
#             DepthWiseConv2d(256, 256, kernel_size=3, padding=1),
#             # nn.GroupNorm(4, 256),
#             GRN(256),
#             nn.LeakyReLU(inplace=False)
#         )
...
#         #     # DepthWiseConv2d(256, 512, kernel_size=1),
#         #     nn.GroupNorm(4, 512),
#         #     nn.LeakyReLU(inplace=False),
#         #     nn.MaxPool2d((2, 2)),
#         #     # AttentionModule(dim=512)
#         # )
#         self.down3 = Down_wt(256, 512)
        
#         # self.msca = AttentionModule(256)
#         # self.mdta = Attention(256)
#         # self.axial = AxialAttention(256)
#         # self.ppa = PPA(in_features=256, filters=256) 反向优化
#         # self.lpa = LPA(in_channel=256)
#         # self.dsam = DSAMBlock(in_channel=256)
#         # self.gct = GCT(in_channel=256)
#         # self.me = MixStructureBlock(dim=256)
#         # self.hwab = HWAB(n_feat=256, o_feat=256)
#         # self.fec = dct_channel_block(256)
#         # self.pcbam = PCBAM(in_channels=256)
#         # self.haam = HAAM(256, 256)
#         # self.swa = SWA(256)
#         # self.mab = MAB(256)
#         # self.ghpa = Grouped_multi_axis_Hadamard_Product_Attention(256, 256)
#         # self.cpca2d = CPCABlock(256, 256)
#         # self.sa = AttentionConv(256, 256)
#         # self.mdcr = MDCR(256, 256)
#         # self.dicam = DICAM()
#         # self.naf = NAFBlock(256)
...
#     random_images = torch.randn(1, 3, 1024, 2048).to(device)
#     model = SegNetwork().to(device)
#     # out = model(random_images)
#     # num_params = count_parameters(model)

# #     print('parameters: %.2fM(%d)' % (num_params / 1e6, num_params))
# #     print(out.shape)
# #     print(model)
################################# baseline + HWD + MDCR + GRN ##########################
# import torch
# import torch.nn as nn
# import torch.nn.functional as F
# from torch.distributions.normal import Normal
...
#         self.res2 = nn.Sequential(
#             # nn.Conv2d(128, 128, kernel_size=(3, 3), padding=(1, 1)),
#             DepthWiseConv2d(128, 128, kernel_size=(3, 3), padding=(1, 1)),
#             # nn.GroupNorm(4, 128),
#             GRN(128),
#             nn.LeakyReLU(inplace=False),
#             # nn.Conv2d(128, 128, kernel_size=(3, 3), padding=(1, 1)),
...
#             nn.ConvTranspose2d(512,256, kernel_size=(2, 2), stride=(2, 2)),
#             # nn.Conv2d(256, 128, kernel_size=3, padding=1),
#             DepthWiseConv2d(256, 128, kernel_size=(3, 3), padding=(1, 1)),
#             # nn.GroupNorm(4, 128),
#             GRN(128),
#             nn.LeakyReLU(inplace=True),
#             # nn.Conv2d(128, 128, kernel_size=3, padding=1),
...
#             nn.ConvTranspose2d(64, 32, kernel_size=(2, 2), stride=(2, 2)),
#             # nn.Conv2d(32, 32, kernel_size=3, padding=1),
#             DepthWiseConv2d(32, 32, kernel_size=(3, 3), padding=(1, 1)),
#             # nn.GroupNorm(4, 32),
#             GRN(32),
#             nn.LeakyReLU(inplace=True),
#             # nn.Conv2d(32, 32, kernel_size=3, padding=1),
...
# from HWD import Down_wt
# # from GRN import GRN
# from PConv import EnhancedPartialConv2d
...
#         self.inc = nn.Sequential(
#             EnhancedPartialConv2d(3, 64, kernel_size=(3, 3), padding=(1, 1)),
#             nn.GroupNorm(4, 64),
#             nn.LeakyReLU(inplace=False)
#         )
...
#         self.res1 = nn.Sequential(
#             EnhancedPartialConv2d(64, 64, kernel_size=(3, 3), padding=(1, 1)),
#             nn.GroupNorm(4, 64),
#             nn.LeakyReLU(inplace=False),
#             EnhancedPartialConv2d(64, 64, kernel_size=(3, 3), padding=(1, 1)),
#             nn.GroupNorm(4, 64),
...
#         self.res2 = nn.Sequential(
#             EnhancedPartialConv2d(128, 128, kernel_size=(3, 3), padding=(1, 1)),
#             nn.GroupNorm(4, 128),
#             nn.LeakyReLU(inplace=False),
#             EnhancedPartialConv2d(128, 128, kernel_size=(3, 3), padding=(1, 1)),
#             nn.GroupNorm(4, 128),
...
#         self.res3 = nn.Sequential(
#             EnhancedPartialConv2d(256, 256, kernel_size=(3, 3), padding=(1, 1)),
#             nn.GroupNorm(4, 256),
#             nn.LeakyReLU(inplace=False),
#             EnhancedPartialConv2d(256, 256, kernel_size=(3, 3), padding=(1, 1)),
#             nn.GroupNorm(4, 256),
